...
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WantFragment.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(WantFragment.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
    ...
    protected void onDestroy() {
        ...
        WantFragment.activityList.remove(this);
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            item1 = new CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
                    mBNRoutePlanNode.getCoordinateType(), getResources().getDrawable(R.drawable.item_pop_want),
