...
import com.demo.travelsociety.adapter.RouteLineAdapter;
import com.demo.travelsociety.utils.BikingRouteOverlay;
import com.demo.travelsociety.utils.DrivingRouteOverlay;
import com.demo.travelsociety.utils.MassTransitRouteOverlay;
import com.demo.travelsociety.utils.OverlayManager;
import com.demo.travelsociety.utils.TransitRouteOverlay;
import com.demo.travelsociety.utils.WalkingRouteOverlay;
 ...
 */
public class Gps extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("深圳", start.getText().toString());
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("深圳", end.getText().toString());
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(Gps.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(Gps.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShownDialogue) {
                    MyTransitDlg myTransitDlg = new MyTransitDlg(Gps.this,
